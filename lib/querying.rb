...
def select_series_title_with_most_human_characters
  "SELECT series.title FROM characters INNER JOIN series ON characters.series_id=series_id GROUP BY series.title HAVING COUNT(characters.species='human') ORDER BY characters.species='human' DESC LIMIT 1;"
end
